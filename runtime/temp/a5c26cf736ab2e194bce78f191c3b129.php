<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:68:"E:\WWW\feichangcelue/application/index\view\ucenter\mobile\sell.html";i:1543283851;s:65:"E:\WWW\feichangcelue/application/index\view\public\PublicNav.html";i:1539064450;}*/ ?>
<!doctype html>
<html>
				    ...
				    <li class="mui-table-view-cell mui-collapse">
				        ...
				        <div class="cont mui-row">
				        	...
				        	<div class="num_info color_red mui-text-right mui-col-xs-3 mui-col-sm-3">
								...
								<input type="text" index="<?php echo $i; ?>" value="" class="money_update">
