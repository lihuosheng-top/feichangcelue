<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:98:"/data/wwwroot/sm00009.sm00009.com/feichangcelue/application/index/view/ucenter/mobile/payment.html";i:1532589692;}*/ ?>
<!doctype html>
<html>
	<head>
		<meta charset="UTF-8">
	...
	<body class="payment_body">
		...
		<div class="mui-content">
			...
			<ul class="mui-table-view">
				...
				<li class="mui-table-view-cell mui-media">
					<a href="../ucenter/bank_transfer.html">
