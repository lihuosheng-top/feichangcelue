<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:80:"D:\phpStudy\WWW\feichangcelue/application/index\view\index\mobile\month_buy.html";i:1539068688;}*/ ?>
<!doctype html>
<html>
    ...
    <div id="item2" class="mui-control-content mui-active bg_fff">
        ...
        <div class="result_box">
            ...
            <div class="protocol_row last_p pad10">
                ...
                <a href="./gift.html" target="_blank">申请即表示已阅读并同意《尚牛在线配资协议》</a>
            </div>
        </div>
