<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:74:"D:\phpStudy\WWW\feichangcelue/application/index\view\index\pass_reset.html";i:1539917664;s:68:"D:\phpStudy\WWW\feichangcelue/application/index\view\public\top.html";i:1539832463;s:71:"D:\phpStudy\WWW\feichangcelue/application/index\view\public\footer.html";i:1539593722;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<section class="section section-forgot-pwd" id="forgot-pwd-step1">
   	<div class="container">
        <nav class="step-bar-thin">
            <ul class="group">
            	<li class="col-3 active step-done"><a href="javascript:;"><i>1</i>密码重置</a></li>
                <li class="col-3 active"><a href="javascript:;"><i>2</i>密码找回</a></li>
        ...
        <div class="step-body group">
            <form action="#" data-success="">
                <div class="field-wrapper">
                    <input class="text" placeholder="请重新设置密码" name="pwd" id="pwd" type="password">
                </div>
                <div id="pwd_err1" class="error-wrapper" style="display:none"><div><i class="icon icon-x-altx-alt"></i>密码长度不能少于6位</div></div>
                <div class="field-wrapper">
                    <input class="text" placeholder="请再次输入密码" name="cpwd" id="cpwd" type="password">
                </div>
                <div id="cpwd_err1" class="error-wrapper" style="display:none"><div><i class="icon icon-x-altx-alt"></i>两次密码不一致</div></div>
                <div class="btn-wrapper">
                    <a href="javascript:;" id="step3-btn" class="btn btn-pri">下一步</a>
                </div>
            </form>
        </div>
    </div>
