<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:86:"D:\phpStudy\WWW\feichangcelue/application/index\view\ucenter\mobile\freetrialSell.html";i:1543630951;s:74:"D:\phpStudy\WWW\feichangcelue/application/index\view\public\PublicNav.html";i:1539064450;}*/ ?>
<!doctype html>
<html>
				    ...
				    <li class="mui-table-view-cell mui-collapse">
				        ...
				        <div class="cont mui-row">
				        	...
				        	<div class="num_info color_red mui-text-right mui-col-xs-3 mui-col-sm-3">
								<input type="text" value="" index="<?php echo $i; ?>" class="money_update">
				        ...
				        <div class="share_info mui-collapse-content">
				            <ul>
				            	...
				            	<li class="mui-clearfix">
				            		...
				            		<span class="li_r mui-pull-right font12"><?php if($list2[$i]['delayDays'] > 2): ?><?php echo $list2[$i-1][delayDays] * 18; else: ?>0<?php endif; ?></span>
				            	</li>
				            	<li class="mui-clearfix">
