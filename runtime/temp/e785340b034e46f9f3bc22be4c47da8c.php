<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:86:"D:\phpStudy\PHPTutorial\WWW\feichangcelue/application/index\view\index\mobile\buy.html";i:1537861891;}*/ ?>
<!doctype html>
<html>
				...
				<div class="chose_item mui-col-xs-9 mui-col-sm-9">
					...
					<p>
						<select>
							...
							<option value="">11天</option>
							<option value="">12天</option>
							<option value="">13天</option>
							<option value="">14天</option>
							<option value="">15天</option>
							<option value="">16天</option>
							<option value="">17天</option>
							<option value="">18天</option>
							<option value="">19天</option>
							<option value="">20天</option>
							<option value="">21天</option>
							<option value="">22天</option>
							<option value="">23天</option>
							<option value="">24天</option>
							<option value="">25天</option>
							<option value="">26天</option>
							<option value="">27天</option>
							<option value="">28天</option>
							<option value="">29天</option>
							<option value="">30天</option>
							<option value="">31天</option>
						</select>
					</p>
				</div>
...
<!--<script>-->
	<!--$("#buy_bt").click(function () {-->
        ...
        <!--var surplus= $("#check-surplus_ul a").html();//触发止盈-->
        ...
        <!--$.ajax({-->
            ...
            <!--data:{-->
                ...
                <!--delayLine:0, //递延条件？-->
                <!--delayFee:18,//递延费（元/天）?从另外一个数据库读取?-->
    ...
    <!--$(".box_con div a").eq(0).click(function () {-->
...
<script>
    ...
    $("#buy_bt").click(function () {
        ...
        var publicFee =$("#publicFee_all").html(); //交易综合费
        var guaranteeFee =$("#guaranteeFee").html(); //履约保证金
		var all_price_sum =$(".all_price_sum").html();
        //递延条件？
		var fee_condition = guaranteeFee * delayLineRate;
        //递延费（元/天）?从另外一个数据库读取
		var diyanfei =delayFee;
        //创建时间
        ...
        $.ajax({
            ...
            data:{
                ...
                delayFee:diyanfei,//递延费（元/天）?从另外一个数据库读取?
