<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:72:"D:\phpStudy\WWW\feichangcelue/application/index\view\index\notice_t.html";i:1540440501;s:68:"D:\phpStudy\WWW\feichangcelue/application/index\view\public\top.html";i:1539832463;s:77:"D:\phpStudy\WWW\feichangcelue/application/index\view\public\PcPublicFoot.html";i:1540193277;}*/ ?>
<!DOCTYPE html>
<html lang="en">
	<head>
		<meta charset="UTF-8">
...
//  });
    //退出登录
		...
		<div id="" style="margin-top: 200px; ">
			...
			<table style="margin: 100px auto; ">
				<tr>
					<td height="50" align="center" valign="middle" style="font-size:24px; color:#666;text-align: center;" class="title" title=""></td>
    ...
    <div class="foots">
		...
		<script>
			$.ajax({
				type: 'POST',
				url: '<?php echo url("index/index/notice_t"); ?>',
				dataType: 'json',
