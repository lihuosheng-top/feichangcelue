<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:86:"D:\phpStudy\WWW\feichangcelue/application/index\view\ucenter\mobile\bank_transfer.html";i:1543031846;s:74:"D:\phpStudy\WWW\feichangcelue/application/index\view\public\PublicNav.html";i:1539064450;}*/ ?>
<!DOCTYPE html>
				...
				<div style="background-color:#fff">
					<div class="offline-wrap">
						...
						<!--<ul class="each-line clearfix">-->
							...
							<!--</li>-->
							<!--<li>-->
								<!--&lt;!&ndash;<span style="color: red;float: right">755928537410701</span>&ndash;&gt;-->
								<!--<span style="color: red;float: right">75592853741</span>-->
								<!--&lt;!&ndash;<input type="text" placeholder="请输入充值金额" disabled="" value="755928537410701" style="color: #ff0000;">&ndash;&gt;-->
							<!--</li>-->
						<!--</ul>-->
						...
						<!--<ul class="each-line clearfix">-->
							...
							<!--<li>-->
								...
								<!--&lt;!&ndash;<input type="text" placeholder="请输入充值金额" disabled="" value="深圳市尚美时尚产业投资管理有限公司" style="color: #ff0000;">&ndash;&gt;-->
							<!--</li>-->
						<!--</ul>-->
						...
						<ul class="each-line clearfix">
							...
							<li>
								...
								<!--<span style="color: red;float: right">广西斯柯美装饰工程有限公司</span>-->
								<!--<input type="text" placeholder="请输入充值金额" disabled="" value="深圳市尚美时尚产业投资管理有限公司" style="color: #ff0000;">-->
							</li>
						</ul>
						...
						<!--<ul class="each-line clearfix">-->
							...
							<!--</li>-->
							<!--<li>-->
								<!--&lt;!&ndash;<span style="color: red;float: right">招商银行股份有限公司深圳中心城支行</span>&ndash;&gt;-->
								<!--<span style="color: red;float: right">广西南宁市区农村信用合作联社安吉信用社</span>-->
								<!--&lt;!&ndash;<input type="text" placeholder="请输入充值金额" disabled="" value=" 招商银行股份有限公司深圳中心城支行" style="color: #ff0000;">&ndash;&gt;-->
							<!--</li>-->
						<!--</ul>-->
