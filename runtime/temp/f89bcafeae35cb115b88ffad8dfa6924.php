<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:93:"D:\phpstudy\PHPTutorial\WWW\feichangcelue/application/index\view\index\index_information.html";i:1540305965;}*/ ?>
<!DOCTYPE html>
<html lang="en">
    ...
    <div class="pz-day-public pzdaytimes">
        ...
        <div class="pz-select">
            <div class="nav_listdown" id="nav_listdown">
                <p class="set_listdown" id="beilv"><span class="j-num" id="num">5</span>倍</p>
    ...
    <div class="pz-day-public pzdaynumber">
        ...
        <div class="pz-select">
            <div class="nav_listdown" id="nav_listdown2">
                <p class="set_listdown" id="day"><span class="j-num" id="num_day">20</span>天</p>
               <!-- <ul class="new_listdown">
    ...
    <table>
        ...
        <tr>
            ...
            <td width="300" style="background-color:#fcfcfc;">
                <div style="width:250px; margin:0 auto 0 16px;"><span id="total_money">500</span>元</div>
            </td>
            <td>获得资金</td>
            <td><span id="gain_money">500</span>元</td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <!--<td><span id="RateValue">0.1</span>%</td>-->
            <td>资金使用期：</td>
            <td><span id="duration">20</span>天</td>
        </tr>
        <tr>
