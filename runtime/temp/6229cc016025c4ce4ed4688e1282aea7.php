<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:93:"D:\phpStudy\PHPTutorial\WWW\feichangcelue/application/index\view\index\index_information.html";i:1539337280;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
...
$(".nav_listdown li").on("click",function(){
    ...
    var stopLossRate = parseFloat("<?php echo $stopLossRate; ?>");/*亏损警戒线*/
    var lossLine =parseFloat("<?php echo $lossLine; ?>");/*亏损线*/
//  alert(stopLossRate);
//  alert(lossLine);
