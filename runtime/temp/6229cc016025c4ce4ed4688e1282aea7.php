<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:93:"D:\phpStudy\PHPTutorial\WWW\feichangcelue/application/index\view\index\index_information.html";i:1540039271;}*/ ?>
<!DOCTYPE html>
<html lang="en">
...
<script>
    ...
    function applyFinancingQy() {
        var day_select=$("#num_day").text();//选中的月数的值
        var ajax_html = $("#total_money").text(); //总配资的值
        var yuebeishu =$("#num").text();
//          $(".box").css("display","block");
        $.ajax({
            type: 'POST',
            url: "<?php echo url('index/index/ajax_free'); ?>",
