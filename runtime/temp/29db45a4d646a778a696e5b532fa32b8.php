<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:95:"/data/wwwroot/sm00009.sm00009.com/feichangcelue/application/index/view/ucenter/mobile/home.html";i:1536401702;s:92:"/data/wwwroot/sm00009.sm00009.com/feichangcelue/application/index/view/public/PublicNav.html";i:1536401702;}*/ ?>
<!doctype html>
<html >
			...
			<div class="person_content mui-content" style="min-height: 100%;">
		        ...
		        <li class="mui-table-view-cell">
		         ...
		         <li class="mui-table-view-cell">
					...
					<li class="mui-table-view-cell">
						<a href="<?php echo url('/invite'); ?>" class="mui-navigate-right" id="aaa">
							我要推广
						</a>
					</li>
