<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:86:"D:\phpstudy\PHPTutorial\WWW\feichangcelue/application/index\view\index\mobile\buy.html";i:1543629704;}*/ ?>
<!doctype html>
<html>
...
<div class="mui-content">
	...
	<div class="bg_fff mui-segmented-control mui-segmented-control-inverted">
		<a class="mui-control-item mui-active" href="./buy.html">按日点买</a>
		<a class="mui-control-item " href="./month_buy.html">按月点买</a>
	...
	<div id="item2" class="mui-control-content mui-active bg_fff">
		...
		<div class="mui-input-row mui-row">
			<span class="mui-col-xs-3 mui-col-sm-3 span_buy_l" style="font-size: 14px !important;">我要配资金额</span><input type="text" value="<?php echo $_SESSION['Con_Lists']; ?>" id="buy_number" class="ajax_html" maxlength="4">万元
		</div>
		<?php else: ?>
		<div class="mui-input-row mui-row">
...
<script src="__STATIC__/home/js/moblie/buy_mine.js"></script>
<script>
    // 如果不在交易时间，不能点买
