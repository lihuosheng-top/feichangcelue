<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:85:"D:\phpStudy\PHPTutorial\WWW\feichangcelue/application/index\view\index\mobile\pz.html";i:1537862619;}*/ ?>
<!DOCTYPE html>
<html>
<head lang="en">
    <meta charset="UTF-8">
...
//			$(".con_one .con_list>p").eq(5).find("i").html((a*b/2).toFixed(2));
			$(".con_one .con_list>p").eq(5).find("i").html((a*b*lossLine).toFixed(2));
			if(b==3){
//             	$(".con_one .con_list>p").eq(6).find("i").html(-(a*b*0.26667).toFixed(2));
             	$(".con_one .con_list>p").eq(6).find("i").html(-(a*stopLossRate).toFixed(2));
...
//			$(".con_one .con_list>p").eq(8).find("i").html((a*b/10000*18).toFixed(2));
			$(".con_one .con_list>p").eq(8).find("i").html((a*b/10000*delayFee +levers *a/100).toFixed(2));
...
//			$(".con_two .con_list>p").eq(5).find("i").html((a*b/2).toFixed(2));
			$(".con_two .con_list>p").eq(5).find("i").html((a*b*lossLine).toFixed(2));
            if(b==3){
//                $(".con_two .con_list>p").eq(6).find("i").html(-(a*b*0.26667).toFixed(2));
                $(".con_two .con_list>p").eq(6).find("i").html(-(a*stopLossRate).toFixed(2));
...
//			$(".con_two .con_list>p").eq(8).find("i").html((a*b/10000*18*30*0.7).toFixed(2));
			$(".con_two .con_list>p").eq(8).find("i").html((a*b/10000*delayFee*30*0.7+levers_month*a*30/100).toFixed(2));
...
//                    $(".con_two .con_list>p").eq(6).find("i").html(-(a*b*0.26667).toFixed(2));
                    $(".con_two .con_list>p").eq(6).find("i").html(-(a*stopLossRate).toFixed(2));
                    //倍数下标
                    var Multiple =  $(".con_two .con_list>p").eq(6).find("i");
                    var levers_month = levers_month_3;
                };
                if(b==4){
//                    $(".con_two .con_list>p").eq(6).find("i").html(-(a*b*0.2).toFixed(2));
...
//				$(".con_two .con_list>p").eq(8).find("i").html((a*b/10000*18*30*0.7).toFixed(2));
				$(".con_two .con_list>p").eq(8).find("i").html((a*b/10000*delayFee*30*0.7+a*levers_month*30/100).toFixed(2));
...
//        });
        ...
        $(" .con_one .con_btn input").click(function () {
        	var day_select=$(".select_day option:selected").text();
...
//                    window.location.href = "./buy";
        ...
        $(" .con_two .con_btn input").click(function () {
        	var moon_select=$(".select_moon option:selected").text();
        	console.log(moon_select);
