<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:85:"D:\phpStudy\PHPTutorial\WWW\feichangcelue/application/index\view\index\mobile\pz.html";i:1539655516;}*/ ?>
<!DOCTYPE html>
<html>
<head lang="en">
    <meta charset="UTF-8">
    ...
    <div class="content">
    	...
    	<div class="con_two">
    		<div class="con_list">
	    		...
	    		<p><span>亏损平仓线</span><span><i>0</i>元</span></p>
	    		<p><span>风险保障金</span><span><i>0</i>元</span></p>
	    		<p><span>预存管理费</span><span class="fs"></span>（一次性收取所有月份管理费）<span><i>0</i>元</span></p>
    		</div>
    		<div class="con_s">申请即表示已阅读并同意<a href="./gift.html"><<尚牛在线配资协议>></a></div>
    		<div class="con_pay">
    			<p class="con_spa"><span>共计应支付：</span><span class="all_allprice">0</span></p>
    			<p class="con_ps">准备资金=风险保证金+月管理费*月数</p>
    		</div>
    		<div class="con_btn"><input type="button" value="立即申请" /></div>
...
//			$(".con_one .con_list>p").eq(8).find("i").html((a*b/10000*18).toFixed(2));
		...
		$(".con_two .con_p li").click(function(){
			...
			//获取月数的值
			var month_num =$('.select_month option:selected').val();
...
//			$(".con_two .con_list>p").eq(8).find("i").html((a*b/10000*18*30*0.7).toFixed(2));
			$(".con_two .con_list>p").eq(8).find("i").html((month_num *levers_month*a*Multiple/100).toFixed(2));
...
//				$(".con_two .con_list>p").eq(8).find("i").html((a*b/10000*18*30*0.7).toFixed(2));
				$(".con_two .con_list>p").eq(8).find("i").html((month_num*a*levers_month*Multiple/100).toFixed(2));
