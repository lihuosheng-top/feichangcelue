<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:79:"D:\phpstudy\PHPTutorial\WWW\feichangcelue/application/index\view\index\reg.html";i:1539763040;s:80:"D:\phpstudy\PHPTutorial\WWW\feichangcelue/application/index\view\public\top.html";i:1539831897;s:83:"D:\phpstudy\PHPTutorial\WWW\feichangcelue/application/index\view\public\footer.html";i:1539655516;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8">
...
<section class="section section-form " id="section-reg">
    <div class="container ">
        <div class="container-reg">
            <h2>注册</h2>
            <!--<div><img src="<?php echo url('index/Index/captchas'); ?>" alt=""></div>-->
            <div class="form">
            	<!--用户名-->
                ...
                <div id="mobileno6" class="field-wrapper">
                    <input type="text" class="text" placeholder="请输入推荐码" name="recommend_code" id="recommend_code">
                </div>
...
<script src="__STATIC__/home/js/reg.js"></script>
