<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:76:"D:\phpStudy\WWW\feichangcelue/application/index\view\index\reset_result.html";i:1539745145;s:68:"D:\phpStudy\WWW\feichangcelue/application/index\view\public\top.html";i:1539832463;s:71:"D:\phpStudy\WWW\feichangcelue/application/index\view\public\footer.html";i:1539593722;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
   	...
   	<div class="container">
        <nav class="step-bar-thin">
            <ul class="group">
                ...
                <li class="col-3 active step-done"><a href="javascript:;"><i>2</i>密码找回</a></li>
                <li class="col-3 active last"><a href="javascript:;"><i>3</i>完成</a></li>
            </ul>
        </nav>
        <div class="step-body group">
            
            <div class="field-wrapper">
                <p class="status-msg status-msg-success"><i class="icon icon-checkmark2"></i>登录密码找回成功！</p>
            </div>
            <div class="btn-wrapper">
                <a href="./login.html" class="btn btn-pri">登录</a>
            </div>
        </div>
    </div>
</section>
