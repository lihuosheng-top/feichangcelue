<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:88:"D:\phpStudy\PHPTutorial\WWW\feichangcelue/application/index\view\index\mobile\index.html";i:1537254911;}*/ ?>
<!DOCTYPE html>
<html>
<head lang="en">
	<meta charset="UTF-8">
...
<div class="wapper">
	...
	<div id="stock-data" class="stock-data"><div class="hd"><i class="icon-prefixer"></i> 国内指数
        </div> <div class="weui-flex bd"><div class="weui-flex__item stock-data__item"><div class="flex-item-wrapper"><div class="title">上证指数</div> <div class="stock-number  number-red">
                        2699.9501
                    </div> <div class="meta"><span class="point number-red">48.16</span> <span class="percent-red number-red">1.82%</span></div></div></div> <div class="weui-flex__item stock-data__item"><div class="flex-item-wrapper"><div class="title">深证成指</div> <div class="stock-number number-xxl number-red">
                        8133.22
                    </div> <div class="meta"><span class="point number-red">133.87</span> <span class="percent number-red">1.67%</span></div></div></div></div></div>
