<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:100:"D:\phpStudy\PHPTutorial\WWW\feichangcelue/application/index\view\index\index_information_second.html";i:1539565566;}*/ ?>
<!DOCTYPE html>
<html lang="en">
			...
			<div class="pz-day-public pzdaytimes">
				...
				<div class="pz-select">
					<div class="nav_listdown" id="nav_listdown">
						<p class="set_listdown" id="beilv"><span class="j-num" id="num">1</span>倍</p>
						<ul class="new_listdown">
							<li class="j-multiple-item" data-id="1" data-rate="0.10">
								<span class="multiple">1</span>倍
							</li>
							<li class="j-multiple-item" data-id="2" data-rate="0.10">
								<span class="multiple">2</span>倍
							</li>
							<li class="j-multiple-item" data-id="3" data-rate="0.09">
								<span class="multiple">3</span>倍
							</li>
							<li class="j-multiple-item" data-id="4" data-rate="0.09">
								<span class="multiple">4</span>倍
							</li>
							<li class="j-multiple-item" data-id="5" data-rate="0.08">
								<span class="multiple">5</span>倍
							</li>
							<li class="j-multiple-item" data-id="6" data-rate="0.08">
								<span class="multiple">6</span>倍
							</li>
							<li class="j-multiple-item" data-id="7" data-rate="0.07">
								<span class="multiple">7</span>倍
							</li>
							<li class="j-multiple-item" data-id="8" data-rate="0.07">
								<span class="multiple">8</span>倍
							</li>
							<li class="j-multiple-item" data-id="9" data-rate="0.065">
								<span class="multiple">9</span>倍
							</li>
							<li class="j-multiple-item" data-id="10" data-rate="0.06">
...
//				总操盘资金：
				$("#total_money").text(allnum);
//				获得资金
				$("#gain_money").text(allnum);
//				亏损警戒线：
                var loss_warn=stopLossRate*bao+allnum;
				$("#loss_warn").text(loss_warn);
				//               亏损平仓线
				 var loss_close=lossLine*bao+allnum;
				$("#loss_close").text(allnum);
...
//				亏损警戒线：
			...
			//  保证金改变
			$("#deposite_money").change(function() {

				var a = $(this).val();
				$("#deposit_money").html(a);
