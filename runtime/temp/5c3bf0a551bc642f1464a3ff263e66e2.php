<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:79:"D:\phpStudy\WWW\feichangcelue/application/index\view\ucenter\freetrialSell.html";i:1543670297;s:68:"D:\phpStudy\WWW\feichangcelue/application/index\view\public\top.html";i:1543649029;s:71:"D:\phpStudy\WWW\feichangcelue/application/index\view\public\footer.html";i:1543670644;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    ...
    <section class="play-area">
        <nav>
            <ul class="clearfix">
                ...
                <li class="active"><a href="./freetrialSell.html"><em>02 </em>| （体验）点卖区</a></li>
        ...
        <section>
            ...
            <ul id="sell-list">
                ...
                <li class="br-clearfix">
                    ...
                    <label class="w180" style="line-height: 50px;">
                    	<input type="text"  value="" class="money_update" style="width: 100px;">
                    <button data-id="<?php echo $vo['id']; ?>"  class="money_add  font12" style="width: 40px;height: 25px; line-height: 25px;">补仓</button>
                   	<button class="btnSell" id="<?php echo $vo['id']; ?>" index="<?php echo $i; ?>" class="btn btn-pri sell-btn " class="btn btn-pri sell-btn " style="width: 160px;height: 25px; line-height: 25px;">点卖（不可递延）</button>
            ...
            <div class="data-empty"><p>暂时没有等待卖出的A股</p><a href="./freetrial.html">立即去点买</a></div>
            <?php endif; ?>
