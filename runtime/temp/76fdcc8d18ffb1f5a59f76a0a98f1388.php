<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:81:"D:\phpStudy\PHPTutorial\WWW\feichangcelue/application/index\view\index\index.html";i:1541484266;s:80:"D:\phpStudy\PHPTutorial\WWW\feichangcelue/application/index\view\public\top.html";i:1540180439;s:89:"D:\phpStudy\PHPTutorial\WWW\feichangcelue/application/index\view\public\PcPublicFoot.html";i:1540259834;s:83:"D:\phpStudy\PHPTutorial\WWW\feichangcelue/application/index\view\public\footer.html";i:1540973532;}*/ ?>
<!DOCTYPE html>
<html lang="en">
						...
						<div class="hq_sv" style="width: 358px;">
							<div class="hq_st">
								<div class="hq_a1" id="a0001_v1">
									<li class="sv sznum" style="color: rgb(255, 0, 0);" ><?php echo $sz_info_arr[3]; ?></li>
									<li class="ico "></li>
									<li class="icon-right szup"><?php echo $sz_info_arr[31]; ?></li>
									<li class="icon-right szdown"><?php echo $sz_info_arr[32]; ?></li>
								</div>
								<div class="hq_aq1_xq" id="a0001_detail">
									<p>
										<span> <span class="xq-color">今开：</span>
										<font color="#237c02" class="today_open"><?php echo $sz_info_arr[5]; ?></font>
										</span>
										<span><span class="xq-color">成交量：</span>
										<font color="#237c02" class="volume"><?php echo $sz_info_arr[6]; ?></font>
										</span>
										<span><span class="xq-color">振幅：</span>
										<font color="#007cc8" class="amplitude"><?php echo $sz_info_arr[43]; ?></font>
										</span>
										<span><span class="xq-color">最高：</span>
										<font color="#237c02" class="highest"><?php echo $sz_info_arr[41]; ?></font>
										</span>
										<span><span class="xq-color">成交额：</span>
										<font color="#007cc8" class="turnover"><?php echo $sz_info_arr[37]; ?></font>
										</span>
										<span><span class="xq-color">昨收：</span>
										<font color="#007cc8" class="yesterday_closed"><?php echo $sz_info_arr[4]; ?></font>
										</span>
										<span><span class="xq-color">总市值：</span>
										<font color="#007cc8" class="total_value"><?php echo $sz_info_arr[45]; ?></font>
										</span>
									</p>
								</div>
								<div class="gupiao">
						...
						<div class="hq_sv" style="width: 358px;">
							<div class="hq_st">
								<div class="hq_a1" id="a0001_v1">
									...
									<li class="icon-right szdown">0</li>
								</div>
								<div class="hq_aq1_xq" id="a0001_detail">
									<p>
										<span> <span class="xq-color">今开：</span>
