<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:75:"D:\phpStudy\WWW\feichangcelue/application/index\view\ucenter\bankcards.html";i:1543637282;s:68:"D:\phpStudy\WWW\feichangcelue/application/index\view\public\top.html";i:1543634244;s:76:"D:\phpStudy\WWW\feichangcelue/application/index\view\public\member_left.html";i:1543633981;s:71:"D:\phpStudy\WWW\feichangcelue/application/index\view\public\footer.html";i:1543641251;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
            ...
            <form action="#" id="d_bank_add">
                ...
                <div class="field-row group">
                    ...
                    <div class="field-val openname"><label id="姓名" style="text-align:left;color: #000;font-size: 16px;">请先进行实名认证</label>
                        <a id="a_realname" target="_blank" href="./security.html" style="font-size:13px;line-height:40px;color: #dd0000;">(点击这里实名认证)</a>
                    </div>
                </div>
                ...
                <div class="field-row group">
                    <label>支行名称</label>
                    <div class="field-val"><input type="text" class="text" id="名称i" placeholder="如宁波北仑分行/上海浦东分行等" val = "<?php echo $bankcard['branch']; ?>"></div>
...
<script src="__STATIC__/home/js/backcards.js"></script>
</body>
</html>
