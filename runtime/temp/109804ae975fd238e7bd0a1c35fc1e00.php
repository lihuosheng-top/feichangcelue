<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:99:"D:\phpStudy\PHPTutorial\WWW\feichangcelue/application/index\view\index\index_information_first.html";i:1539565621;}*/ ?>
<!--按月-->
<!DOCTYPE html>
<html lang="en">
			...
			<div class="pz-day-public pzdaytimes">
				...
				<div class="pz-select">
					<div class="nav_listdown" id="nav_listdown">
						<p class="set_listdown"><span class="j-num" id="num">1</span>倍</p>
				...
				<tbody>
					<tr>
						...
						<td width="300" style="background-color:#fcfcfc;">
							<div style="width:250px; margin:0 auto 0 16px;"><span id="borrow_money">200</span>元</div>
						</td>
						<td>获得资金</td>
