<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:88:"D:\phpStudy\PHPTutorial\WWW\feichangcelue/application/index\view\index\mobile\qqsay.html";i:1536206168;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="UTF-8">
...
<div class="mui-content" style="margin: 10px 20px 0;">
    ...
    <div class="box" style="margin-bottom: 20px">
        <span>财务QQ：</span>
        <a style="display: inline-block;width: 100px; height: 30px" onclick="jia_qq(910705652)"><img width="100%" src="http://wpa.qq.com/pa?p=2:1061525487:51"></a>
    </div>
