<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:80:"D:\phpStudy\WWW\feichangcelue/application/index\view\index\mobile\freetrial.html";i:1541036528;}*/ ?>
<!doctype html>
<html>
...
<div class="mui-content">
	...
	<div class="bg_fff mui-segmented-control mui-segmented-control-inverted">
		<a class="mui-control-item mui-active" href="./freetrial.html">按日点买(体验)</a>
		<a class="sell_a mui-control-item" href="<?php echo url('index/ucenter/freetrialSell'); ?>">点卖(体验)</a>
		<a class="mui-control-item" href="<?php echo url('index/ucenter/freetrialHistory'); ?>">结算(体验)</a>
	</div>
	<!--内容-->
	<div id="item1" class="mui-control-content mui-active">
		...
		<div class="search_box">
			<div class="mui-input-row mui-search">
				<input id="searchTxt1" type="search" name="keywords"
					   class="mui-input-clear" placeholder="请输入股票名称/代码/简拼">
			</div>
	...
	<div id="item2" class="mui-control-content mui-active bg_fff">
		...
		<div class="t_stock_name share_title bg_fff mui-clearfix" style="padding-bottom: 0;">
			...
			<div class="title_r mui-pull-right mui-text-right">
				<h5 class="color_red" style="font-size: 24px;"><?php echo (isset($freebleSum) && ($freebleSum !== '')?$freebleSum:0); ?></h5>
				<p>账户余额(元)</p>
			</div>
		</div>
		<p class="p_title1 color_black bg_fff" style="display: none">推荐配资金额</p>
		<div id="buy_price_ul" class="choseBox1 mui-row mui-text-center bg_fff" style="display: none;">
		...
		<div class="mui-input-row mui-row">
			<span class="mui-col-xs-3 mui-col-sm-3 span_buy_l" style="font-size: 14px !important;">我要配资金额</span><input type="text" placeholder="请输入金额" id="buy_number" maxlength="4" value="0.05" disabled >万元
		</div>
		...
		<ul class="choseBox2" style="margin: 0;">
			<li class="mui-row chose_aim">
				...
				<p class="mui-col-xs-3 mui-col-sm-3">综合费用</p>
				<div class="chose_item mui-col-xs-9 mui-col-sm-9">
					<a class="bz_text" href="javascript:void(0);" style="color: black;">0.1%</a>
				</div>
				<p class="mui-col-xs-3 mui-col-sm-3">履约保证金</p>
				<div class="chose_item mui-col-xs-9 mui-col-sm-9">
					<a id="guaranteeFee" class="bz_text" href="javascript:void(0);">0</a>
					<span id="g_text"></span>
				</div>
			</li>
			<li class="mui-row">
				<p id="check-surplus" class="mui-col-xs-3 mui-col-sm-3">亏损警戒线</p>
				<div id="check-surplus_ul" class="chose_item mui-col-xs-9 mui-col-sm-9">
					<a class="bz_text" href="javascript:void(0);">5000元</a>
				</div>
			</li>
			<li class="mui-row">
				<p class="mui-col-xs-3 mui-col-sm-3">亏损平仓线</p>
				<div id="stop-loss_ul" class="chose_item mui-col-xs-9 mui-col-sm-9 mui-row mui-text-center" >
					<a class="bz_a   chose_a chose_a_bot mui-col-xs-3 mui-col-sm-3 font12" href="javascript:void(0);" style="opacity: 0.2;" >-600</a>
					<a class="bz_a  chose_a chose_a_bot mui-col-xs-3 mui-col-sm-3 font12" href="javascript:void(0);" style="opacity: 0.2;" >-800</a>
					<a class="bz_a chose-active  chose_a chose_a_bot mui-col-xs-3 mui-col-sm-3 font12" href="javascript:void(0);">-1000</a>
					<a class="bz_a  chose_a chose_a_bot mui-col-xs-3 mui-col-sm-3 font12" href="javascript:void(0);" style="opacity: 0.2;">-1200</a>
					<a class="bz_a  chose_a chose_a_bot mui-col-xs-3 mui-col-sm-3 font12" href="javascript:void(0);" style="opacity: 0.2;">-1332</a>
					<a class="bz_a  chose_a chose_a_bot mui-col-xs-3 mui-col-sm-3 font12" href="javascript:void(0);" style="opacity: 0.2;">-1600</a>
					<a class="bz_a  chose_a chose_a_bot mui-col-xs-3 mui-col-sm-3 font12" href="javascript:void(0);" style="opacity: 0.2;">-1700</a>
					<a class="bz_a  chose_a chose_a_bot mui-col-xs-3 mui-col-sm-3 font12" href="javascript:void(0);" style="opacity: 0.2;">-1800</a>
				</div>
			</li>
		</ul>
		<div class="result_box">
			<ul class="pad10" style="margin: 0;">
				<li class="mui-clearfix">
					<span class="li_l mui-pull-left">利息费用</span>
				...
				<li class="total mui-clearfix">
					...
					<span class="li_r mui-pull-right"><span id="total" class="color_red all_price_sum">2000</span>&nbsp;元</span>
				</li>
			</ul>
			...
			<div class="protocol_row last_p pad10">
				...
				<a href="./gift.html" target="_blank">申请即表示已阅读并同意《尚牛在线配资委托管理资金协议》</a>
			</div>
		</div>
		<button id="buy_step3" type="button" class="ml_btn_bot mui-btn mui-btn-block buy_step3 Buy_Step">买入</button>
	</div>
</div>
<div id="box">
	<div class="box_con">
		<p style="color: red">提示</p>
		<p>交易品种:<b class="J_name"></b></p>
		<p>交易总操盘:<b></b>万元</p>
		<p>交易数量:<b></b>手</p>
...
<div id="box_alert" style="display: none">
	<div class="box_con">
		<p style="color: red">提示</p>
		<h5 style="color: red">请选择买入金额或输入谋略金额！</h5>
		<div><button class="buy_cance">前往填写金额</button><button class="buy_cance" >返回</button></div>
	</div>
</div>
<script>
    //数据初始化
...
<script src="__STATIC__/home/js/moblie/freetrial_moblie.js"></script>
<script>
    // 如果不在交易时间，不能点买
    ...
    $(".Buy_Step").click(function () {
        //首先判断输入框中的值，首次为NAN则默认值为1万
        var dealAmount =$('#buy_number').val();
        if(dealAmount ==""){
            $("#box_alert").css("display","block");
        }else {
            $("#box").css("display","block");
            $(" #box .box_con").find('b').eq(1).html(dealAmount);//买入的金额
            //股票多少手
            var dealQuantity =$("#gu").html();
            $("#box .box_con").find('b').eq(2).html(dealQuantity/100);
        }
    })
...
<script>
    ...
    $("#buy_bt").click(function () {
        var dealQuantity =$("#gu").html();
        var  dealAmount =$('#buy_number').val();
        var name = $("#stockName").html();
        var stockCode =$("#stockNum").html();//股票代码
        var nowPrice =$("#nowPrice").html();//成交价格（成交订单的实时价格）
        var surplus= $("#check-surplus_ul a").html();//警戒线
        var loss =$("#stop-loss_ul .chose-active").html();//触发止损
        var publicFee =$("#publicFee_all").html(); //交易综合费
        var guaranteeFee =$("#guaranteeFee").html(); //履约保证金
        var all_price_sum =$(".all_price_sum").html(); //总金额
        var buy_day_num = $(".select_day option:selected").val(); //配资的天数
        //递延条件？(保证金*后台递延的多少倍)
        var fee_condition = guaranteeFee * delayLineRate;
        var Multiple  =dealAmount*10000/guaranteeFee; //配资的倍数
        /*倍数后台过来的尴尬倍率*/
        switch(Multiple)
        {
            case 3:
                var levers_multiples = levers_3;
                break;
            case 4:
                var levers_multiples = levers_4;
                break;
            case 5:
                var levers_multiples = levers_5;
                break;
            case 6:
                var levers_multiples = levers_6;
                break;
            case 7:
                var levers_multiples = levers_7;
                break;
            case 8:
                var levers_multiples = levers_8;
                break;
            case 9:
                var levers_multiples = levers_9;
                break;
            case 10:
                var levers_multiples = levers_10;
                break;
        }
        ...
        $.ajax({
            type:"post",
            url:"<?php echo url('index/Ucenter/freetrialBuy'); ?>",
            data:{
                name:name,//股票的名字
                stockCode:stockCode, //股票代号
                nowPrice:nowPrice, //成交价格
                dealAmount:dealAmount, //交易总操盘
                dealQuantity:dealQuantity, //交易多少手(数量)
                surplus:surplus,//警戒线
                loss:loss, //触发止损
                publicFee:publicFee,//交易综合费
                guaranteeFee:guaranteeFee, //履约保证金
                buy_day_num :buy_day_num, //配资的天数
                delayLine:fee_condition, //递延条件
                delayFee:day_deferred,//递延费（元/天)
                all_price_sum:all_price_sum, //总计金额
                stock_by_pay_type:1,	//判断买入的类型是按月还是按日（1为按天，2为按月）
                Multiple:Multiple,  //买入时的倍数
                levers_multiples:levers_multiples, //买入倍数对应的杠杆率
            },
            dataType:'json',
            success:function(data){
                if(data.code ==0) {
                    ...
                    $("#box").css("display","none");
                    setTimeout(function(){
                        window.location.href = './ucenter/home';
                    },2000)
                }
                if(data.code ==1) {
                    mui.alert(data.msg);
