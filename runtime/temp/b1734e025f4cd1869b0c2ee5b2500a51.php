<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:80:"D:\phpStudy\WWW\feichangcelue/application/index\view\index\mobile\freetrial.html";i:1537668163;}*/ ?>
<!doctype html>
<html>
	...
	<body class="buy_body">
		...
		<div class="mui-content">
			...
			<div class="bg_fff mui-segmented-control mui-segmented-control-inverted">
				...
				<a class="sell_a mui-control-item" href="<?php echo url('index/ucenter/freetrialSell'); ?>">点卖</a>
				<a class="mui-control-item" href="<?php echo url('index/ucenter/freetrialHistory'); ?>">结算</a>
			</div>
			<!--内容-->
			<div id="item1" class="mui-control-content mui-active">
				...
				<div class="search_box">
					<div class="mui-input-row mui-search">
						<input id="searchTxt1" type="search" name="keywords" class="mui-input-clear" placeholder="请输入股票名称/代码/简拼">
					</div>
			...
			<div id="item2" class="mui-control-content mui-active bg_fff">
				...
				<div class="mui-input-row mui-row">
				    <span class="mui-col-xs-3 mui-col-sm-3 span_buy_l" style="font-size: 14px !important;">我要配资金额</span><input type="text" placeholder="请输入谋略金额" id="buy_number" maxlength="2" onkeypress="if(event.keyCode==13||event.which==13){return false;}" onkeyup="this.value=this.value.replace(/[^\.\d]/g,'');this.value=this.value.replace('.','');">万元
				</div>
...
//
		...
		<script>
            $("#buy_bt").click(function () {
                ...
                //递延条件？
				var cont = guaranteeFee *delayLineRate;
                //递延费（元/天）?从另外一个数据库读取
				var frees =delayFee;
                //创建时间
                ...
                $.ajax({
                    ...
                    data:{
                        ...
                        delayLine:cont, //递延条件？
                        delayFee:frees,//递延费（元/天）?从另外一个数据库读取?
